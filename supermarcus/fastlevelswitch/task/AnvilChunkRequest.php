...
class AnvilChunkRequest extends AsyncTask {
    protected $levelId;
    protected $chunkX;
    protected $chunkZ;
    ...
    public function onRun(){
        ...
        $ordered = \zlib_encode(\pack("V", $this->chunkX) . \pack("V", $this->chunkZ) . $orderedIds . $orderedData . $orderedSkyLight . $orderedLight . $this->biomeIds . $biomeColors . $this->tiles, ZLIB_ENCODING_DEFLATE, $this->compressionLevel);
